...
months_left = int(input('Enter the number months left before your passport expires: '))
months_to_entry = int(input('Enter the number of months to your intended travel date: '))
    
#Do not remove the next line that calls the function
validity = check_validity(months_left, months_to_entry)

print('Result returned from function is', validity) #Modify to print the result returned from function
